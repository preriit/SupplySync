...
- [x] Step 14 parity wave 2 + pilot rollout is completed and documented (tracking in `docs/MIGRATION_STEP14_PARITY_WAVE2_AND_PILOT.md`).
- [x] Step 15 post-pilot hardening + admin baseline is delivered and validated (tracking in `docs/MIGRATION_STEP15_POST_PILOT_HARDENING_AND_ADMIN_BASELINE.md`).
...
- Related tickets: Migration steps tracked in:
  ...
  - `docs/MIGRATION_STEP14_PARITY_WAVE2_AND_PILOT.md`
  - `docs/MIGRATION_STEP15_POST_PILOT_HARDENING_AND_ADMIN_BASELINE.md`
